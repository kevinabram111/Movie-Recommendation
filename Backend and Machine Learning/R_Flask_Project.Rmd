...
# Add your bearer token here that you get from TMDB
response <- VERB("GET", url, query = queryString, add_headers('Authorization' = ''), content_type("application/octet-stream"), accept("application/json"))
...
# Your API key and base URL from TMDB
api_key <- ""
